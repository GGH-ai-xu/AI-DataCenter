...
<template>
  <nav class="app-primary-nav-rail">
    <div class="app-primary-nav__head">
      <div class="app-primary-nav__eyebrow">Workspace</div>
      <p class="app-primary-nav__caption">围绕当前导入范围切换治理、分析与支持视图。</p>
    </div>
...
.app-primary-nav__head {
  display: grid;
  gap: 8px;
}

.app-primary-nav__eyebrow {
